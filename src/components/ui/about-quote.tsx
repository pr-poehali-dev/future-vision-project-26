        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              G80 — это место, где каждый вечер превращается в особенный. Уютная лаунж-атмосфера, живая музыка, профессиональные бармены и тщательно подобранное меню напитков — всё создано для того, чтобы вы чувствовали себя как дома, но лучше.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы находимся в самом сердце Донецка — ул. Постышева, 120. Приходите за отличными коктейлями, кальяном и атмосферой, которая заряжает с первых минут. G80 — ваш новый любимый бар.
            </p>
          </div>
        </div>
      </div>
